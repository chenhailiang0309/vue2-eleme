...
export default {
  ...
  methods: {
    ...
    getShopDetailData() {
      return this.$http({
        url: 'http://cangdu.org:8001/shopping/restaurant/' + this.shopId + '?latitude=' + this.latitude + '&longitude=' + this.longitude + '&extras[]=activities&extras[]=album&extras[]=license&extras[]=identification&extras[]=statistics',
        method: 'get'
      })
    },
    // 3、获取商铺食品列表
