...
export default {
  ...
  // directives:loadMore.directives,
  computed: {
    ...mapState([
      'latitude', 'longitude'
    ])
  ...
  methods: {
    initData() {
      ...
      this.$http({
          url: 'http://cangdu.org:8001/shopping/restaurants?latitude=' + this.latitude + '&longitude=' + this.longitude + '&offset=' + this.offset + '&limit=20&extras[]=activities&keyword=&restaurant_category_id=&restaurant_category_ids[]=&order_by=&delivery_mode[]=',
          type: 'get',
        })
        .then(res => {
